...
const WelcomeScreen = ({ onStart }: { onStart: () => void }) => (
  <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-6">
    ...
    <div className="absolute inset-0 pointer-events-none"
      style={{ background: "radial-gradient(ellipse 80% 60% at 50% 40%, rgba(34,197,94,0.07) 0%, transparent 65%)" }} />
        ...
        <div className="h-1 w-full rounded-full overflow-hidden" style={{ background: "rgba(139,105,20,0.1)" }}>
          <div
            ...
            style={{
              ...
              background: "linear-gradient(to right, rgba(34,197,94,0.6), #22C55E)",
            }}
          />
        </div>
      </div>
              ...
              >
                ...
                <div className="flex items-center gap-4 p-4 md:p-5">
                  ...
                  <div className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-300"
                    style={{
                      background: isSelected ? "rgba(34,197,94,0.2)" : "hsl(var(--primary) / 0.08)",
                      border: isSelected ? "1px solid rgba(34,197,94,0.4)" : "1px solid rgba(34,197,94,0.14)",
                    }}>
                    {isSelected ? (
      ...
      <div className="relative w-32 h-32 mx-auto mb-8">
        <svg viewBox="0 0 120 120" className="w-full h-full">
          <g style={{ animation: "spin 3s linear infinite", transformOrigin: "60px 60px" }}>
            <circle cx="60" cy="60" r="56" stroke="rgba(34,197,94,0.25)" strokeWidth="0.5" fill="none" strokeDasharray="4 6" />
            <circle cx="60" cy="60" r="46" stroke="rgba(34,197,94,0.35)" strokeWidth="0.8" fill="none" />
            {[0, 45, 90, 135, 180, 225, 270, 315].map((deg) => (
              <line key={deg}
                x1="60" y1="4" x2="60" y2="18"
                stroke="rgba(34,197,94,0.5)" strokeWidth="1"
          ...
          <g style={{ animation: "spin 2s linear infinite reverse", transformOrigin: "60px 60px" }}>
            <circle cx="60" cy="60" r="32" stroke="rgba(34,197,94,0.4)" strokeWidth="1" fill="none" />
            <polygon points="60,28 72,50 60,72 48,50" stroke="rgba(34,197,94,0.6)" strokeWidth="0.8" fill="rgba(34,197,94,0.06)" />
          </g>
          <circle cx="60" cy="60" r="10" stroke="rgba(34,197,94,0.6)" strokeWidth="1" fill="rgba(34,197,94,0.12)" />
        </svg>
      </div>
          ...
          <div className="animate-fade-up">
            ...
            decoding="async" src={image} alt={meta.name} className="w-full h-full object-cover object-top" />
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <h2 className="font-heading font-black" style={{ fontSize: "clamp(32px, 5vw, 52px)", color: "rgba(134,239,172,0.95)" }}>
                  {meta.name}
                </h2>
                <p className="font-heading italic" style={{ fontSize: "17px", color: "rgba(134,239,172,0.70)" }}>
                  {meta.title}
                </p>
              </div>
            </div>
      ...
      <div className="fixed inset-0 pointer-events-none transition-all duration-1000"
        style={{
          background: state.phase === "result" && state.result
            ...
            : "radial-gradient(ellipse 70% 50% at 50% 30%, rgba(34,197,94,0.04) 0%, transparent 65%)",
        }} />
