          ...
          <div className="grid lg:grid-cols-[280px_1fr] gap-10 lg:gap-16 items-start">
            ...
            <div className="space-y-5">
              {[
                ...
                "మా నాన్న ప్రతిరోజూ భోజనం తర్వాత గీతామకరందము చదివేవారు — శ్రీ విద్యాప్రకాశానందగిరి స్వామీజీ రచించిన తెలుగు వ్యాఖ్యానం. గీతాదేవీ ప్రార్థనతో ప్రారంభించి, అమ్మకు వినిపించేవారు. నేను పక్కన కూర్చుని వినేదాన్ని.",
