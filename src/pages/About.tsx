...
const AboutHero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse 70% 50% at 50% 40%, rgba(34,197,94,0.07) 0%, transparent 65%)" }} />
    ...
    <div className="text-center">
      <div className="font-heading font-black leading-none mb-2" style={{ fontSize: "clamp(48px, 7vw, 80px)" }}>
        <span
          ref={ref}
          style={{
            background: "linear-gradient(135deg, #E8C547 0%, #22C55E 50%, #B8922A 100%)",
...
const StatsSection = () => {
  const ref = useScrollReveal<HTMLDivElement>();
  return (
    <section className="py-10 md:py-14" style={{ background: "linear-gradient(180deg, hsl(var(--parchment-1)), hsl(var(--parchment-2)))", borderTop: "1px solid rgba(34,197,94,0.08)", borderBottom: "1px solid rgba(34,197,94,0.08)" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div ref={imgRef} className="reveal-element">
            <div className="relative rounded-3xl overflow-hidden" style={{ aspectRatio: "4/5", boxShadow: "0 40px 80px rgba(0,0,0,0.5), 0 0 0 1px rgba(34,197,94,0.12)" }}>
              <img
        loading="eager"
        fetchPriority="high"
        decoding="async" src={karnaImg} alt="Karna — the character that started it all" className="w-full h-full object-cover object-top" />
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <p className="font-heading text-xl mb-1" style={{ color: "rgba(134,239,172,0.95)" }}>Karna</p>
  ...
  return (
    <section className="py-12 md:py-16 relative overflow-hidden"
      ...
      <div className="absolute top-8 left-1/2 -translate-x-1/2 font-heading select-none pointer-events-none"
        style={{ fontSize: "240px", lineHeight: 1, color: "rgba(34,197,94,0.04)" }}>
        "
      </div>
      ...
      <div ref={ref} className="reveal-element relative z-10 max-w-4xl mx-auto px-6 md:px-12 text-center">
        ...
        {/* Sanskrit */}
        <p className="font-heading mb-4" style={{ fontSize: "clamp(18px, 2.5vw, 26px)", color: "rgba(34,197,94,0.8)", lineHeight: 1.85, letterSpacing: "0.06em" }}>
        ...
        <p className="font-heading text-[11px] tracking-[0.3em] uppercase" style={{ color: "rgba(34,197,94,0.4)" }}>
          — Bhagavad Gita 4.7
        </p>

        {/* Site's interpretation */}
        <div className="mt-12 max-w-2xl mx-auto">
          <div className="h-px w-16 mx-auto mb-8" style={{ background: "rgba(34,197,94,0.2)" }} />
          ...
          {values.map(({ title, body }, i) => (
            <div key={title} className="reveal-element glass-card rounded-xl p-6 hover-lift group relative overflow-hidden">
              <div className="absolute top-0 left-0 bottom-0 w-0.5 opacity-0 group-hover:opacity-100 transition-opacity duration-400"
                style={{ background: "linear-gradient(to bottom, rgba(34,197,94,0.6), rgba(34,197,94,0.1))" }} />
            ...
            <div className="flex flex-col items-center lg:items-start gap-5">
              ...
              >
                ...
                <svg className="absolute inset-0 w-full h-full" style={{ animation: "spin 30s linear infinite" }} viewBox="0 0 128 128">
                  <circle cx="64" cy="64" r="60" fill="none" stroke="rgba(34,197,94,0.15)" strokeWidth="0.5" strokeDasharray="4 6" />
                </svg>
            ...
            <div className="space-y-5">
              ...
              <div className="pt-4">
                ...
                <a
                  ...
                  style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "15px", color: "rgba(34,197,94,0.7)", textDecoration: "none" }}
                >
  ...
  return (
    <section className="py-12 md:py-16 relative overflow-hidden text-center"
      ...
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse 80% 60% at 50% 50%, rgba(34,197,94,0.06), transparent 65%)" }} />
      ...
      <div ref={ref} className="reveal-element relative z-10 max-w-2xl mx-auto px-6">
        ...
        {/* Newsletter */}
        <div className="glass-card rounded-2xl px-8 py-8 max-w-md mx-auto relative overflow-hidden" style={{ borderColor: "rgba(34,197,94,0.15)" }}>
          <div className="absolute top-0 left-0 right-0 h-px" style={{ background: "linear-gradient(to right, transparent, rgba(34,197,94,0.4), transparent)" }} />
