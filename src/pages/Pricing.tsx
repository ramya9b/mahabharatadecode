        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          ...
          >
              ...
              {(Object.keys(PLANS) as PlanId[]).map((id) => (
                <button
                  ...
                  style={{
                    ...
                    border: selected === id ? "none" : "1px solid rgba(212,175,55,0.2)",
                  }}
                >
                  {PLANS[id].label}
                  {id === "yearly" && " ✦"}
            ...
            <div className="mb-2">
              ...
              {selected === "yearly" && (
                <p style={{ fontSize: "13px", color: "rgba(212,175,55,0.8)", fontFamily: "'Cormorant Garamond', serif" }}>
                  ₹83/month · Save ₹189
                </p>
              )}
            </div>
        ...
        <div>
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={q} style={{ borderBottom: "1px solid rgba(212,175,55,0.1)", paddingBottom: "20px" }}>
                <h3
