  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 50% at 50% 30%, rgba(194,65,12,0.05) 0%, transparent 65%)",
        }}
      />
        ...
        <div className="text-center mb-16">
          <div
            ...
            style={{
              ...
              background: "linear-gradient(135deg, #E8C547 0%, #C2410C 40%, #B8922A 100%)",
              ...
              {QUICK_LINKS.map(({ to, icon: Icon, label, desc }) => (
                ...
                >
                  <div
                    ...
                    style={{ background: "rgba(194,65,12,0.08)", border: "1px solid rgba(194,65,12,0.15)" }}
                  >
