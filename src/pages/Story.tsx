  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 50% 40%, rgba(34,197,94,0.08) 0%, transparent 65%)",
        }}
        aria-hidden="true"
      />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg,#22C55E,#A3E635,#34D399,#38BDF8,#A78BFA,#F472B6)",
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto px-5 sm:px-6 pt-24 pb-16">
        ...
        <h1
          ...
          style={{
            ...
            background:
              "linear-gradient(135deg, rgba(34,197,94,1) 0%, rgba(34,197,94,0.6) 100%)",
        ...
        <p
          ...
          style={{
            ...
            fontFamily: "'Cormorant Garamond', Georgia, serif",
            color: isDark ? "rgba(134,239,172,0.70)" : "rgba(42,31,14,0.70)",
            maxWidth: "540px",
          }}
        >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1 flex-wrap">
            <span
              ...
              style={{
                ...
                color: isDark ? "rgba(134,239,172,0.95)" : "rgba(42,31,14,0.95)",
              }}
            >
              {parva.name}
            </span>
          ...
          <p
            ...
            style={{
              ...
              fontStyle: "italic",
              color: isDark ? "rgba(134,239,172,0.60)" : "rgba(42,31,14,0.62)",
            }}
          >
            {parva.subtitle}
          </p>
      ...
      <main id="main-content" className="max-w-3xl mx-auto px-4 md:px-6 py-10">
        ...
        <div className="relative">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, transparent, rgba(34,197,94,0.25) 10%, rgba(34,197,94,0.25) 90%, transparent)",
            }}
            aria-hidden="true"
          />
