  ...
  if (showIntro) {
    return (
      <>
        ...
        {isGlobalDark && (
          <>
            <div style={{
              ...
              background: "radial-gradient(ellipse 60% 60% at 80% 35%, rgba(107,45,143,0.16) 0%, transparent 50%)",
            }} />
            <div style={{
              position: "absolute", inset: 0, pointerEvents: "none",
              background: "radial-gradient(ellipse 50% 55% at 20% 65%, rgba(107,45,143,0.12) 0%, transparent 50%)",
            }} />
            <div style={{
              position: "absolute", inset: 0, pointerEvents: "none",
        ...
        `}</style>
        {/* Rainbow top bar */}
        <div style={{ position:"absolute", top:0, left:0, right:0, height:"2px", background:"linear-gradient(90deg,#6B2D8F,#E4C04A,#6B2D8F,#38BDF8,#A78BFA,#F472B6)", zIndex:10 }} />
        ...
        <h1 className="intro-title" style={{
          ...
          marginBottom: "20px",
          textShadow: "0 0 60px rgba(107,45,143,0.3)",
        ...
        {/* Divider */}
        <div style={{ width: "80px", height: "2px", background: "linear-gradient(90deg, transparent, #6B2D8F, transparent)", margin: "0 auto 20px" }} />
        ...
        <button
          ...
          style={{
            ...
            background: "linear-gradient(135deg, #A07820 0%, #6B2D8F 50%, #A07820 100%)",
            border: "none", cursor: "pointer", fontFamily: serif,
            fontSize: "15px", letterSpacing: "0.15em", color: "#2A1506",
            fontWeight: 600, boxShadow: "0 8px 32px rgba(107,45,143,0.35)",
            transition: "all 0.3s", backgroundSize: "200%",
            animation: "intro-btn 0.8s ease 1s forwards, shimmer 3s ease-in-out 2s infinite",
          }}
          onMouseEnter={e => { e.currentTarget.style.boxShadow = "0 12px 40px rgba(107,45,143,0.55)"; e.currentTarget.style.transform = "translateY(-2px)"; }}
          onMouseLeave={e => { e.currentTarget.style.boxShadow = "0 8px 32px rgba(107,45,143,0.35)"; e.currentTarget.style.transform = "translateY(0)"; }}
        >
          ✨ Enter the Epic
        </button>
      </div>
    ...
    <div style={{
      ...
      {isGlobalDark && (
        <div style={{ position: "fixed", inset: 0, zIndex: 0, pointerEvents: "none" }}>
          {/* Golden Rainbow base */}
          <div style={{ position:"absolute", inset:0, background:"linear-gradient(145deg,#130717 0%,#140919 25%,#0B0714 55%,#08050E 80%,#130717 100%)" }} />
          {/* Gold glow — top-right */}
          <div style={{ position:"absolute", inset:0, background:"radial-gradient(ellipse 55% 60% at 80% 30%, rgba(107,45,143,0.14) 0%, transparent 50%)" }} />
          ...
          <div style={{ position:"absolute", inset:0, background:
            ...
            currentTheme === "gita"   ? "radial-gradient(ellipse 45% 55% at 18% 65%, rgba(107,45,143,0.13) 0%, transparent 50%)" :
            "radial-gradient(ellipse 45% 55% at 18% 65%, rgba(107,45,143,0.12) 0%, transparent 50%)"
          }} />
          {/* Purple mid-glow */}
          ...
          {/* Rainbow top bar */}
          <div style={{ position:"absolute", top:0, left:0, right:0, height:"2px", background:"linear-gradient(90deg,#6B2D8F,#E4C04A,#6B2D8F,#38BDF8,#A78BFA,#F472B6)" }} />
        </div>
      )}
      ...
      >
        ...
        <div style={{
          position: "absolute", inset: 0, pointerEvents: "none",
          background: "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(107,45,143,0.12) 0%, transparent 70%)",
        }} />
        ...
        <div style={{ marginTop: "32px", animation: "bounce 2s infinite" }}>
          <ChevronDown size={24} style={{ color: "rgba(107,45,143,0.4)", margin: "0 auto" }} />
        </div>
        ...
        {(["select", "prompt", "story"] as Step[]).map((s, i) => (
          <div key={s} style={{ display: "flex", alignItems: "center" }}>
            <div style={{
              ...
              background: step === s ? gold : step === "prompt" && s === "select" ? gold : step === "story" ? gold : "rgba(107,45,143,0.15)",
              color: (step === s || (step === "prompt" && s === "select") || step === "story") ? "#2A1506" : inkMuted,
              border: `2px solid ${step === s ? gold : "rgba(107,45,143,0.2)"}`,
              transition: "all 0.3s",
            }}>
              {i + 1}
            </div>
            ...
            {i < 2 && <div style={{ width: "40px", height: "1px", background: "rgba(107,45,143,0.3)" }} />}
          </div>
        ))}
      </div>
          ...
          >
            ...
            <textarea
              ...
              style={{
                ...
                border: `1.5px solid ${customPrompt ? gold : "rgba(107,45,143,0.2)"}`,
            ...
            <button
              ...
              style={{
                ...
                background: (activePromptIdx !== null || customPrompt.trim()) && !loading && canGenerate ? GROUP_COLORS[selected.group] : "rgba(107,45,143,0.2)",
            ...
            {PAYWALL_ENABLED && !subscription && hasAccess && (
              <p style={{
                ...
                color: storiesLeft === 0 ? "rgba(192,57,43,0.8)" : "rgba(107,45,143,0.65)",
                textAlign: "center",
              }}>
                {storiesLeft === 0
                        ...
                        <>
                          ...
                          <textarea
                            ...
                            style={{
                              ...
                              fontFamily: body, fontSize: "14px", color: inkDark,
                              background: "rgba(107,45,143,0.04)",
                              border: `1.5px solid ${situationInput ? ((selected ? GROUP_COLORS[selected.group] : gold)) : "rgba(107,45,143,0.2)"}`,
                          ...
                          <button
                            ...
                            style={{
                              ...
                              background: situationInput.trim() ? ((selected ? GROUP_COLORS[selected.group] : gold)) : "rgba(107,45,143,0.2)",
