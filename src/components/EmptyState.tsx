...
const VARIANT_DEFAULTS: Record<EmptyVariant, { title: string; description: string; icon: ReactNode }> = {
  search: {
    ...
    icon: <SearchX size={28} style={{ color: "rgba(34,197,94,0.7)" }} aria-hidden="true" />,
  },
  articles: {
    title: "No articles yet",
    description: "New stories are being written. Subscribe to be notified when they arrive.",
    icon: <BookOpen size={28} style={{ color: "rgba(34,197,94,0.7)" }} aria-hidden="true" />,
  },
  generic: {
    title: "Nothing here yet",
    description: "Check back soon.",
    icon: <Inbox size={28} style={{ color: "rgba(34,197,94,0.7)" }} aria-hidden="true" />,
  },
};
        ...
        cta.to ? (
          <Link
            ...
            style={{
              padding: "10px 24px",
              borderRadius: "99px",
              background: "linear-gradient(135deg, #E8C547, #22C55E)",
              color: "#08061A",
              fontFamily: "'Cinzel', serif",
              fontSize: "12px",
              fontWeight: 700,
