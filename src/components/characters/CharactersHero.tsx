...
const CharactersHero = ({ characters }: CharactersHeroProps) => {
  ...
  const subtitleColor    = isDark ? "rgba(134,239,172,0.78)" : "rgba(42,31,14,0.85)";
  const heroParaColor    = isDark ? "rgba(134,239,172,0.68)" : "rgba(42,31,14,0.72)";
  const portraitLabel    = isDark ? "rgba(134,239,172,0.65)" : "rgba(42,31,14,0.65)";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 50% at 50% 40%, rgba(34,197,94,0.07) 0%, transparent 65%)",
        }}
      />
