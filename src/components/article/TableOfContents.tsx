  ...
  return (
    <nav
      ...
      style={{
        ...
        border: "1px solid rgba(107,45,143,0.12)",
        borderRadius: "16px",
        overflow: "hidden",
        marginBottom: "32px",
        position: "sticky",
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          border: "none",
          cursor: "pointer",
          borderBottom: collapsed ? "none" : "1px solid rgba(107,45,143,0.1)",
        }}
      >
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <List size={14} style={{ color: "rgba(107,45,143,0.7)" }} aria-hidden="true" />
          <span
            style={{
              ...
              <li key={item.id}>
                <button
                  ...
                  style={{
                    ...
                    color: isActive ? "rgba(107,45,143,0.95)" : "hsl(var(--foreground) / 0.75)",
                  }}
                >
                  ...
                  <span
                    ...
                    style={{
                      ...
                      borderRadius: "50%",
                      flexShrink: 0,
                      background: isActive ? "#6B2D8F" : "transparent",
