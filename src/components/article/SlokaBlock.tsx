  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "0 0 60px rgba(194,65,12,0.05), inset 0 0 60px rgba(194,65,12,0.02)",
      }}
    >
      {/* Corner ornaments */}
      {[
        ...
        <div
          ...
          style={{ borderColor: "rgba(194,65,12,0.25)" }}
        />
      ))}
      ...
      <div className="px-8 md:px-14 py-12 md:py-14 text-center">
        ...
        <div className="flex items-center justify-center gap-4 mb-10">
          <div className="h-px flex-1 max-w-[60px]" style={{ background: "rgba(194,65,12,0.3)" }} />
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          <div className="h-px w-16" style={{ background: "rgba(194,65,12,0.2)" }} />
