      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 lg:px-20">
        <div
          ...
          style={{
            ...
            boxShadow:
              "0 0 80px rgba(107,45,143,0.04), 0 30px 60px rgba(0,0,0,0.4)",
          }}
        >
          {/* Top shimmer */}
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, transparent, rgba(107,45,143,0.45), transparent)",
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 60% 50% at 50% 100%, rgba(107,45,143,0.05) 0%, transparent 70%)",
            }}
          />
            ...
            <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span
                    ...
                    style={{ color: "rgba(107,45,143,0.75)" }}
                  >
                    Daily Wisdom
                  </span>
                </div>
                ...
                >
                  ...
                  <span
                    className="block"
                    style={{
                      background: "linear-gradient(135deg, #E8C547 0%, #6B2D8F 45%, #B8922A 100%)",
                  ...
                  <form onSubmit={handleSubmit} className="flex gap-3">
                    <div
                      ...
                      style={{
                        ...
                        border: "1px solid rgba(107,45,143,0.20)",
                      }}
                    >
                    ...
                    <button
                      ...
                      style={{
                        background: "linear-gradient(135deg, #E8C547, #6B2D8F, #B8922A)",
                        color: "#08040F",
                        fontFamily: "'Cinzel', serif",
                        boxShadow: "0 0 20px rgba(107,45,143,0.3)",
                      }}
                    >
                      Subscribe
                    </button>
              ...
              <div className="hidden md:flex items-center justify-center">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to bottom, transparent, rgba(107,45,143,0.2), transparent)",
                  }}
                />
              </div>
