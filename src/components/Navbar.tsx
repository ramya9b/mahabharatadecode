...
const Navbar = () => {
  ...
  const pillBorder = "rgba(34,197,94,0.22)";
  const pillShadow = "0 8px 40px rgba(0,0,0,0.45), 0 0 0 1px rgba(34,197,94,0.12)";

  const linkColor  = "rgba(245,237,218,0.92)";
  const linkActive = "#22C55E";

  const ctaBg      = "linear-gradient(90deg,#22C55E 0%,#F97316 35%,#EC4899 65%,#A78BFA 100%)";
        ...
        >
          ...
          >
            <div style={{
              ...
              background: "#0E0900",
              boxShadow: "0 0 0 2px #22C55E, 0 0 0 4px rgba(167,139,250,0.4), 0 0 16px rgba(34,197,94,0.25)",
              ...
              <span style={{
                ...
                fontWeight: 700,
                background: "linear-gradient(135deg,#22C55E,#F472B6,#A78BFA)",
            ...
            <span style={{
              ...
              color: "#22C55E",
              whiteSpace: "nowrap",
              textShadow: "0 0 20px rgba(34,197,94,0.80), 0 2px 10px rgba(34,197,94,0.60)",
            }}
          ...
          >
            ...
            <Link
              ...
              onMouseLeave={e => {
                (e.currentTarget as HTMLAnchorElement).style.color = "rgba(34,197,94,0.75)";
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px", flexShrink: 0 }}>
            ...
            <Link
              ...
              style={{
                ...
                textDecoration: "none",
                textTransform: "uppercase",
                boxShadow: "0 4px 24px rgba(34,197,94,0.5), 0 0 0 1px rgba(34,197,94,0.15)",
                whiteSpace: "nowrap",
              ...
              onMouseEnter={e => {
                ...
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 8px 36px rgba(34,197,94,0.65), 0 0 0 1px rgba(34,197,94,0.25)";
              }}
              onMouseLeave={e => {
                (e.currentTarget as HTMLAnchorElement).style.transform = "none";
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 4px 20px rgba(34,197,94,0.3)";
              }}
            >
              {t("nav.start_reading")}
            </Link>
        ...
        >
          ...
          >
            <div style={{
              ...
              background: "#0E0900",
              boxShadow: "0 0 0 2px #22C55E, 0 0 0 3.5px rgba(167,139,250,0.3)",
              display: "flex", alignItems: "center", justifyContent: "center",
              flexShrink: 0,
            }}>
              <span style={{
        ...
        >
          {NAV_LINKS.map(({ to, key }) => (
            <Link
              ...
              style={{
                ...
                color: isActive(to) ? "#22C55E" : "rgba(245,237,218,0.88)",
          ...
          <Link
            ...
            style={{
              ...
              padding: "12px 20px",
              borderRadius: "100px",
              background: "linear-gradient(90deg,#22C55E 0%,#F97316 35%,#EC4899 65%,#A78BFA 100%)",
              color: "#06030E",
              fontFamily: "'Cinzel',serif",
              fontSize: "11px",
              fontWeight: 700,
