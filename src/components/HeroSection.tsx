...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse 75% 55% at 50% 38%, rgba(194,65,12,0.12) 0%, transparent 65%)" }} />
      {/* Vignette edges */}
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto px-6 pt-28 pb-20">
        ...
        >
          <span className="block" style={{
            ...
            filter: "drop-shadow(0 2px 20px rgba(194,65,12,0.5))",
          }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-up-delay-2">
          <Link
            ...
            onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.transform = "translateY(-3px) scale(1.02)"; (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 12px 40px rgba(194,65,12,0.6)"; }}
            onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.transform = "none"; (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 8px 32px rgba(194,65,12,0.45), 0 0 60px rgba(194,65,12,0.15)"; }}
          >
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2" style={{ opacity: 0.5 }} aria-hidden="true">
        <span className="text-[9px] tracking-[0.35em] uppercase" style={{ fontFamily: "'Cinzel', serif", color: "rgba(194,65,12,0.8)" }}>
          {t("hero.scroll")}
        </span>
        <div className="w-px h-10" style={{ background: "linear-gradient(to bottom, rgba(194,65,12,0.7), transparent)" }} />
      </div>
    </section>
  );
};
