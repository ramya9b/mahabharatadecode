  ...
  return (
    <Link
      ...
      onMouseEnter={e => {
        ...
        el.style.boxShadow   = "0 20px 50px rgba(34,197,94,0.14), inset 0 1px 0 rgba(34,197,94,0.12)";
      }}
      onMouseLeave={e => {
        const el = e.currentTarget as HTMLAnchorElement;
        el.style.borderColor = "rgba(34,197,94,0.18)";
      ...
      <div style={{ padding:"20px 22px 18px", display:"flex", flexDirection:"column", flex:1 }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:"8px", marginBottom:"10px" }}>
          <span style={{ display:"flex", alignItems:"center", gap:"5px",
                         color:"rgba(134,239,172,0.75)", fontSize:"11px",
                         fontFamily:"'Cinzel',serif", letterSpacing:"0.06em" }}>
            <Clock size={11} />
            {article.readTime} min read
          </span>
          <span style={{ color:"rgba(134,239,172,0.40)", fontSize:"12px" }}>·</span>
          <span style={{ color:"rgba(134,239,172,0.70)", fontSize:"11px",
