      ...
      <div className="section-header">
        ...
        <div
          ...
          style={{
            ...
            background: "linear-gradient(90deg,transparent,rgba(194,65,12,0.7),transparent)",
          }}
        />
      </div>
        ...
        {characters.map((char) => (
          ...
          >
            ...
            <div
              ...
              style={{
                boxShadow: "inset 0 0 0 1px rgba(194,65,12,0)",
                transition: "box-shadow 0.4s ease",
              }}
              onMouseEnter={e => (e.currentTarget.style.boxShadow = "inset 0 0 0 1px rgba(194,65,12,0.3)")}
              onMouseLeave={e => (e.currentTarget.style.boxShadow = "inset 0 0 0 1px rgba(194,65,12,0)")}
            />
