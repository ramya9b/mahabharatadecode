...
const PARVA_PREVIEWS = [
  { number: "01", name: "Adi Parva",   subtitle: "Bhishma's oath. Karna set adrift. The seeds of war.",    accentHex: "#D4AF37", accentRgb: "212,175,55" },
  ...
  { number: "08", name: "Karna Parva", subtitle: "The final battle. The rivalry nobody could resolve.",     accentHex: "#D4AF37", accentRgb: "212,175,55" },
];
