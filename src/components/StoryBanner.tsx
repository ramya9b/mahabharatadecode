...
const PARVA_PREVIEWS = [
  { number: "01", name: "Adi Parva",   subtitle: "Bhishma's oath. Karna set adrift. The seeds of war.",    accentHex: "#6B2D8F", accentRgb: "107,45,143" },
  ...
  { number: "08", name: "Karna Parva", subtitle: "The final battle. The rivalry nobody could resolve.",     accentHex: "#6B2D8F", accentRgb: "107,45,143" },
];
      ...
      <div style={{ textAlign: "center", marginBottom: "48px" }}>
        ...
        <Link
          ...
          style={{
            ...
            borderRadius: "99px",
            background:
              "linear-gradient(135deg, #6B2D8F 0%, #6B2D8F 50%, #F5E8EE 100%)",
            ...
            letterSpacing: "0.1em",
            textDecoration: "none",
            boxShadow: "0 4px 24px rgba(107,45,143,0.45)",
          ...
          onMouseEnter={(e) => {
            ...
            (e.currentTarget as HTMLAnchorElement).style.boxShadow =
              "0 12px 36px rgba(107,45,143,0.65)";
          }}
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLAnchorElement).style.transform = "none";
            (e.currentTarget as HTMLAnchorElement).style.boxShadow =
              "0 4px 24px rgba(107,45,143,0.45)";
          }}
        >
          📜 Read the Full Story →
        </Link>
