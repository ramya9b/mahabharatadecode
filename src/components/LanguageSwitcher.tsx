  ...
  return (
    ...
    >
      ...
      <button
        ...
        style={{
          background: open ? "rgba(139,105,20,0.12)" : "rgba(139,105,20,0.06)",
          ...
          {SUPPORTED_LANGUAGES.map((lang, idx) => {
            ...
            return (
              <button
                ...
                onFocus={(e) => {
                  (e.currentTarget as HTMLElement).style.background = "rgba(139,105,20,0.08)";
                }}
                onBlur={(e) => {
              ...
              >
                ...
                <span
                  ...
                  style={{
                    background: isActive ? "rgba(139,105,20,0.2)" : "rgba(139,105,20,0.08)",
                    color: "hsl(var(--primary))",
